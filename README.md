...
Import the provided SQL file into the MySQL database to set up the required tables and initial data.
...
If you encounter any issues, check that:
    ...
    Your hibernate.cfg.xml file contains the correct database credentials.
    The database schema has been set up correctly.
